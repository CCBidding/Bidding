...
// RESideMenu-onlyLeft
#define COCOAPODS_POD_AVAILABLE_RESideMenu_onlyLeft
#define COCOAPODS_VERSION_MAJOR_RESideMenu_onlyLeft 4
#define COCOAPODS_VERSION_MINOR_RESideMenu_onlyLeft 0
#define COCOAPODS_VERSION_PATCH_RESideMenu_onlyLeft 7
