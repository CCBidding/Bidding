...
@implementation PPPingYinSearch
+(NSMutableArray *)searchWithOriginalArray:(NSMutableArray *)originalArray andSearchText:(NSString *)searchText andSearchByPropertyName:(NSString *)propertyName{
